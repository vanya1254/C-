int GetAkkermanFunction(int m, int n)
{
    ...
    if (m > 0 && n > 0) return GetAkkermanFunction(m - 1, GetAkkermanFunction(m, n - 1));    // https://wikimedia.org/api/rest_v1/media/math/render/svg/c8c2aa0b20532014ea35c4a09c2380a01b3d1423
